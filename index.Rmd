...
ggplot(baseline, aes(x = health_index)) +
  geom_histogram(bins = 15) + labs(x = "Heath Class", y = "Number of individuals in each health class by species") +
  facet_grid(~species) +
  theme_minimal()
```
